...
def one_column_summary(frame: pl.DataFrame) -> tuple[pl.DataFrame, pl.DataFrame]:
    ...
    frame = frame.with_columns(
        ...
        pl.col("content_type_product").sum(),
        pl.col("content_type_synthetic_media").sum(),
        ...
        pl.col("csam_content_type_product").sum(),
        pl.col("csam_content_type_synthetic_media").sum(),
