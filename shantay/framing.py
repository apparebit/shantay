...
def one_column_summary(frame: pl.DataFrame) -> pl.DataFrame:
    ...
    return frame.with_columns(
        ...
        pl.col("no_visibility_decision").sum(),
        pl.lit(None).alias("    \u2800"),
        ...
        pl.col("no_provision_decision").sum(),
        pl.lit(None).alias("      \u2800"),
        ...
        ).alias("account_suspended_until_date_pct_suspended"),
        pl.col("account_terminated_no_date").sum(),
        pl.col("account_terminated_until_date").sum(),
        pl.lit(None).alias("        \u2800"),
        pl.col("csam").sum(),
        (pl.col("csam").sum() / pl.col("rows").sum() * 100).alias("csam_pct_rows"),
        pl.lit(None).alias("         \u2800"),
        pl.col("csam_no_decision").sum(),
        ...
        pl.col("csam_no_visibility_decision").sum(),
        pl.lit(None).alias("           \u2800"),
        ...
        pl.col("csam_no_monetary_decision").sum(),
        pl.lit(None).alias("             \u2800"),
        ...
        pl.col("csam_no_provision_decision").sum(),
        pl.lit(None).alias("              \u2800"),
        pl.col("csam_account_suspended").sum(),
        pl.col("csam_account_terminated").sum(),
        pl.col("csam_no_account_decision").sum(),
        pl.lit(None).alias("               \u2800"),
        pl.col("csam_account_suspended_no_date").sum(),
        pl.col("csam_account_suspended_until_date").sum(),
        pl.col("csam_account_terminated_no_date").sum(),
